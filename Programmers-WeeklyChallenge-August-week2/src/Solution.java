...
public class Solution {
	 ...
	 * 문제 설명
		...
		자기 자신을 평가한 65점은 자신이 받은 점수 중에서 최저점이지만 같은 점수가 2개 더 있으므로, 
	...
	public static void main(String[] args) {
		...
		// case 1
		int[][] case1 = {{100,90,98,88,65},{50,45,99,85,77},{47,88,95,80,67},{61,57,100,80,65},{24,90,94,75,65}};
	...
	public String solution(int[][] scores) {
        ...
        for(int i = 0; i < scores.length; i++) {
        	...
        	if(list.indexOf(self) == scores.length - 1) {
